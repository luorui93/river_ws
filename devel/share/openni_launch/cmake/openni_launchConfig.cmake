...
if("TRUE" STREQUAL "TRUE")
  set(openni_launch_SOURCE_PREFIX /home/riverwheelchair/river_ws/src/openni_launch)
  set(openni_launch_DEVEL_PREFIX /home/riverwheelchair/river_ws/devel)
  ...
  set(openni_launch_INSTALL_PREFIX /home/riverwheelchair/river_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openni_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/riverwheelchair/river_ws/src/openni_launch/${idir}'.  Ask the maintainer 'Isaac I.Y. Saito <130s@2000.jukuin.keio.ac.jp>' to fix it.")
    endif()
