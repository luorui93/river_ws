...
if("FALSE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/yaphes/river_ws/src/test)
  set(test_DEVEL_PREFIX /home/yaphes/river_ws/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/yaphes/river_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yaphes/river_ws/install/${idir}'.  Ask the maintainer 'riverwheelchair <riverwheelchair@todo.todo>' to fix it.")
    endif()
