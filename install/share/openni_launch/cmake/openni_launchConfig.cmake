...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openni_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/riverwheelchair/river_ws/install/${idir}'.  Ask the maintainer 'Isaac I.Y. Saito <130s@2000.jukuin.keio.ac.jp>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/riverwheelchair/river_ws/install/lib;/opt/ros/indigo/lib)
